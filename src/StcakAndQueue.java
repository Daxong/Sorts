 ...
 *
 *Error:(8, 8) java: class StackAndQueue is public, should be declared in a file named StackAndQueue.java
 */
public class StcakAndQueue {
    /**
    ...
    public static void main(String args[]){
        StcakAndQueue job=new StcakAndQueue();
